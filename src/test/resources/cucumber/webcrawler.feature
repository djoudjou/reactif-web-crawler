...
<address>Apache/2.4.10 (Debian) Server at wallagain.cc Port 80</address>
    ...
    """
    Then result should have title "0_0_le_jour_de_cong_de_tatsumaki_5676a32b90a8a" with date "2015-12-21 22:14"
    And result should have title "0_2_special_sentai_52ca2d478266" with date "2016-05-08 17:24"
    And result should have title "53_0_fighting_spirit_56161ee5bf29a" with date "2015-10-29 22:04"
    And result should have title "53_2_bonus_1_5627957774af2" with date "2015-10-21 19:31"
    And result should have title "53_3_bonus_2_562799048cd4e" with date "2015-10-21 19:30"
    And result should have title "54_0_intrusion_563287d7661d3" with date "2015-10-30 19:29"
    And result should have title "55_0_lintrusion_continue_565460a254506" with date "2015-11-24 14:12"
    And result should have title "56_0_les_tnbres_se_rapprochent_565c6d8750fb3" with date "2016-01-10 21:08"	 
    And result should have title "57_0_seulement_toi_569273e4218a8" with date "2016-05-07 13:41"	 
    And result should have title "58_0__56b77f3bac67e" with date "2016-02-08 21:43"
    And result should have title "59_0_outsider_56d17be1ad9f1" with date "2016-05-08 22:07"
    And result should have title "60_0__la_raison_de_ma_recherche_572dd11b59e51" with date "2016-05-08 17:23"